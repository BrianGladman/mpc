...
\centerline{\includegraphics[width=5cm]{iter1.pdf}}
  \caption{Extremal (by above) values of $a_1$ (solid curve) and $b_1$ (dotted curve) after the first
    iteration of the AGM. The values are bounded by below by the $x$-axis.}
\end{figure}
